...
with st.form("preingreso_form"):
    cliente_mercaderia = st.text_input("Cliente / Mercadería", max_chars=100, placeholder="Obligatorio")
    nombre_chofer = st.text_input("Nombre del chofer", max_chars=100, placeholder="Obligatorio")
    dni_chofer = st.text_input("DNI del chofer", max_chars=20, placeholder="Obligatorio")
    patente_camion = st.text_input("Patente del camión", max_chars=20, placeholder="Obligatorio")
    patente_acoplado = st.text_input("Patente del acoplado", max_chars=20, placeholder="Obligatorio")
    celular_whatsapp = st.text_input("Número de celular o WhatsApp", max_chars=20, placeholder="Obligatorio")
    remito_permiso_embarque = st.text_input("Número de Remito o Permiso de Embarque", max_chars=50, placeholder="Obligatorio")
