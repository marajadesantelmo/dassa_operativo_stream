...
def fetch_data_impo_historico():
    ...
    arribos_impo_historico = arribos_impo_historico[arribos_impo_historico['Cliente'].str.contains('Lawter')].drop(columns=['Cliente'])
    historico_retiros_impo = pd.read_csv('data/historico_retiros_impo.csv')
    historico_retiros_impo = historico_retiros_impo[historico_retiros_impo['Cliente'].str.contains('Lawter')].drop(columns=['Cliente'])
